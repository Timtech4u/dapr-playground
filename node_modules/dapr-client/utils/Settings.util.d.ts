...
export declare class Settings {
    ...
    private static readonly defaultHttpAppPort;
    private static readonly defaultHttpPort;
    private static readonly defaultGrpcAppPort;
    private static readonly defaultGrpcPort;
    private static readonly defaultCommunicationProtocol;
    private static readonly defaultKeepAlive;
    private static readonly defaultStateGetBulkParallelism;
    private static readonly daprSidecarPollingDelayMs;
    private static readonly daprSidecarStartupTimeoutMs;
