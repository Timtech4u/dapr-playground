...
class HTTPServer {
    constructor(client, options) {
        ...
        this.server = (_a = options.serverHttp) !== null && _a !== void 0 ? _a : (0, express_1.default)();
        this.server.use(body_parser_1.default.text({
            limit: `${(_c = (_b = this.serverOptions) === null || _b === void 0 ? void 0 : _b.maxBodySizeMb) !== null && _c !== void 0 ? _c : 4}mb`,
        }));
        this.server.use(body_parser_1.default.raw({
            type: ["application/octet-stream"],
            limit: `${(_e = (_d = this.serverOptions) === null || _d === void 0 ? void 0 : _d.maxBodySizeMb) !== null && _e !== void 0 ? _e : 4}mb`,
        }));
        this.server.use(body_parser_1.default.json({
            ...
            limit: `${(_g = (_f = this.serverOptions) === null || _f === void 0 ? void 0 : _f.maxBodySizeMb) !== null && _g !== void 0 ? _g : 4}mb`,
        }));
    ...
    start(host, port) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.serverInstance = yield this.server.listen(parseInt(port, 10));
    ...
    stop() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.serverTerminator) {
                yield this.serverTerminator.terminate();
            }
            this.isInitialized = false;
        });
    }
