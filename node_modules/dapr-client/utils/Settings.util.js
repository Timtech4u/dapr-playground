...
class Settings {
    ...
    static getDefaultCommunicationProtocol() {
        return Settings.defaultCommunicationProtocol;
    }
    static getDefaultKeepAlive() {
    ...
    static getDefaultStateGetBulkParallelism() {
...
Settings.defaultCommunicationProtocol = CommunicationProtocol_enum_1.default.HTTP;
Settings.defaultKeepAlive = true;
Settings.defaultStateGetBulkParallelism = 10;
